...
" Colours {{{1 
"" General {{{2
hi Normal       ctermfg=252 guifg=#dcdcdc ctermbg=234 guibg=#1c1c1c cterm=none gui=none
...
hi Identifier   ctermfg=182 guifg=#ef9dee                           cterm=none
hi Ignore       ctermfg=238 guifg=#555555
hi Number       ctermfg=180 guifg=#efb280
hi PreProc      ctermfg=150 guifg=#afdf87
hi Special      ctermfg=174 guifg=#e57373
hi Statement    ctermfg=110 guifg=#73abef                           cterm=none gui=none
